const products = [
    ...
    function renderProducts() {
        ...
        products.forEach(product => { const card = document.createElement('div');
            card.className = 'product-card';

            card.innerHTML = `
                <div class="product-image">
                    <img src="${product.thumbnail}" alt="${product.title}">
                    <div class="product-image-element-1">${product.discountPercentage}%</div>
                    <div class="product-image-element-2">${product.category}</div>
                </div>
